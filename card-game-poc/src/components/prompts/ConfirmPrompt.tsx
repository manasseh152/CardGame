...
import type { ConfirmPromptMessage } from '@/hooks/useWebSocket';
...
export function ConfirmPrompt({ prompt, onSubmit, onCancel, className }: ConfirmPromptProps) {
    ...
    return (
        <div onKeyDown={handleKeyDown} className={cn("space-y-4", className)}>
